...
function validateDomainSync(domain, companyName) {
  ...
  if (!foundMatch && companyWords.length > 0) {
    // If the domain is just the words smashed together (e.g., "gigroup" from "gi group")
...
console.log(validateDomainSync('enel.com', 'Enel'));
console.log(validateDomainSync('bendingspoons.com', 'Bending Spoons'));
