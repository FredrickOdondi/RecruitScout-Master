...
console.log("Gi Group -> gigroup.com:", validateDomainSync('gigroup.com', 'Gi Group'));
console.log("A2A -> a2a.it:", validateDomainSync('a2a.it', 'A2A'));
console.log("Enel -> enel.com:", validateDomainSync('enel.com', 'Enel'));
console.log("TIM -> tim.it:", validateDomainSync('tim.it', 'TIM'));
console.log("FS Italiane -> fsitaliane.it:", validateDomainSync('fsitaliane.it', 'FS Italiane'));
