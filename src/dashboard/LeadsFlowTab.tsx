        ...
        {selectedRecruiter ? (
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-hidden grid grid-cols-1 lg:grid-cols-5">
              ...
              <div className="lg:col-span-3 flex flex-col h-full bg-slate-50/50 min-h-0">
                <div className="px-4 py-2.5 border-b border-slate-100 bg-white flex justify-between items-center shrink-0">
                  ...
                  {!currentDraft && (
                    <button
                      ...
                      className="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1 rounded-md text-[11px] font-bold transition-all shadow-sm flex items-center gap-1 shrink-0"
                    >
