...
const ActivityIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>;
      ...
      <aside className={`fixed inset-y-0 left-0 transform ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 transition-transform duration-300 z-50 border-r border-gray-200 bg-white flex flex-col flex-shrink-0 ${isSidebarCollapsed ? 'md:w-20 w-64' : 'w-64 xl:w-72'}`}>
        ...
        <nav className="flex-1 px-4 py-4 space-y-2 relative overflow-x-hidden">
          ...
          >
            ...
            {!isSidebarCollapsed && <span className="font-medium text-sm whitespace-nowrap text-blue-600">Blue.cc Workspaces</span>}
          </button>
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 py-2 mt-1 rounded-md transition-all ${isSidebarCollapsed ? 'md:justify-center px-3 md:px-0' : 'px-3'} ${activeTab === 'leads' ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'}`}
          >
          ...
          <button 
            ...
            title="Leads Flow"
            className={`w-full flex items-center gap-3 py-2 mt-1 rounded-md transition-all ${isSidebarCollapsed ? 'md:justify-center px-3 md:px-0' : 'px-3'} ${activeTab === 'leads-flow' ? 'bg-gray-100 text-gray-900 font-medium' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'}`}
          >
        ...
        <div className={`p-4 border-t border-gray-200 flex flex-col gap-2`}>
          ...
          <button
            onClick={onLogout}
            title="Sign Out"
            className={`flex items-center justify-center gap-3 py-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-all text-sm font-medium group ${isSidebarCollapsed ? 'md:w-10 md:h-10 md:px-0 w-full px-4 mx-auto' : 'w-full px-4'}`}
          >
