                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-900 flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="bg-amber-500/10 text-amber-400 hover:bg-amber-100 px-2 py-1 rounded text-[11px] font-medium border border-amber-500/20 transition-all"
                            ...
                            <tr key={q.id} className={`border-b border-gray-200 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/80'} hover:bg-gray-100`}>
                              {isEditing ? (
                                ...
                                <>
                                  ...
                                  <td className="px-3 py-1.5">
                                    {q.date_filter ? (
                                      <span className={`px-2 py-0.5 rounded border text-[11px] font-medium ${q.date_filter === 'last' ? 'bg-amber-500/10 text-amber-400 border-amber-500/20' : 'bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 border-cyan-500/20'}`}>
                                  ...
                                  <td className="px-3 py-1.5 text-right">
                                    <button 
                                      ...
                                      className="text-cyan-400 hover:text-blue-800 font-medium text-[12px] px-2 py-1"
